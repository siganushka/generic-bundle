...
use Siganushka\GenericBundle\Form\Extension\ChoicePlaceholderTypeExtension;
...
return static function (ContainerConfigurator $container): void {
    $container->services()
        ->set('siganushka_generic.form.type_extension.button_priority', ButtonPriorityTypeExtension::class)
            ->tag('form.type_extension')

        ->set('siganushka_generic.form.type_extension.choice_placeholder', ChoicePlaceholderTypeExtension::class)
            ->tag('form.type_extension')
