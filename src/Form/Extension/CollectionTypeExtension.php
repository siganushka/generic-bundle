...
class CollectionTypeExtension extends AbstractTypeExtension
{
    ...
    public function configureOptions(OptionsResolver $resolver): void
    {
        ...
        $resolver->setNormalizer('add_button_options', static function (Options $options, array $value) {
        ...
        $resolver->setNormalizer('delete_button_options', static function (Options $options, array $value) {
